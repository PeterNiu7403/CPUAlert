...
if ([string]::IsNullOrWhiteSpace($SourceIcon)) {
    $SourceIcon = Join-Path $repoRoot "Assets\Square150x150Logo.scale-200.png"
}
...
$brandFontsDir = Join-Path $repoRoot "Assets\Fonts"
...
function New-ScaledBitmap {
    ...
    if ($Transparent) {
        ...
        $graphics.Clear([System.Drawing.ColorTranslator]::FromHtml("#12100D"))
    }
