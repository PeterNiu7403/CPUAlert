...
/// </summary>
public sealed record MoleWindowsEnvelope
{
    [JsonPropertyName("ok")]
    ...
    public string? MoleWindowsCli { get; init; }
    ...
    public MoleWindowsError? Error { get; init; }
    ...
    /// </summary>
    public static MoleWindowsEnvelope Parse(string stdout)
        => JsonSerializer.Deserialize<MoleWindowsEnvelope>(stdout, Options)
...
/// </summary>
public sealed record MoleWindowsError
{
