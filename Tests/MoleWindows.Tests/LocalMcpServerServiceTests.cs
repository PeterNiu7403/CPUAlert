...
public sealed class LocalMcpServerServiceTests
{
    ...
    public void BuildMcpToolArray_IncludesCanonicalCrossPlatformToolNames()
    {
        ...
        Assert.Contains("molewindows_list_apps", names);
        Assert.Contains("molewindows_purge", names);
        Assert.Contains("molewindows_installer", names);
        Assert.Contains("molewindows_uninstall", names);
    }
    ...
    public async Task ExecuteToolByNameAsync_RejectsStringHistoryLimit()
    {
        ...
        var response = await ExecuteToolAsync(service, "molewindows_history", arguments);
    ...
    public async Task ExecuteToolByNameAsync_ListAppsUsesCanonicalToolName()
    {
        ...
        Assert.Equal("molewindows_list_apps", response["tool"]!.GetValue<string>());
    ...
    public async Task ExecuteToolByNameAsync_PurgeIsPreviewOnly()
    {
        ...
        var response = await ExecuteToolAsync(service, "molewindows_purge", arguments);
    ...
    public async Task ExecuteToolByNameAsync_InstallerIsPreviewOnly()
    {
        ...
        var response = await ExecuteToolAsync(service, "molewindows_installer", arguments);
    ...
    private sealed class FakeApplicationSettingsService : IApplicationSettingsService
    {
        ...
        public MoleWindowsSettings Current { get; } = new()
        {
        ...
        public Task<MoleWindowsSettings> SaveAsync(MoleWindowsSettings settings, CancellationToken cancellationToken = default)
        {
