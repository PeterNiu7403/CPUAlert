...
public sealed class TrayIconTextFormatterTests
{
    ...
    {
        Assert.Equal("Mole Windows - 准备中", TrayIconTextFormatter.BuildTooltip(null));
    }
    ...
    public void BuildTooltip_IncludesCpuAndMemoryPercentages()
    {
        ...
        Assert.Equal("Mole Windows CPU 24% 内存 52%", TrayIconTextFormatter.BuildTooltip(snapshot));
    }
