...
namespace MoleWindows.Ui;

public static class MoleWindowsButtonVisualState
{
    ...
    private static readonly string[] MoleWindowsButtonStyleKeys =
    [
        "MoleWindowsPillButtonStyle",
        "MoleWindowsSecondaryPillButtonStyle",
        "MoleWindowsTopNavButtonStyle",
        "MoleWindowsTopNavButtonSelectedStyle",
        "MoleWindowsIconButtonStyle",
        "MoleWindowsIconButtonSelectedStyle"
    ];
    ...
    {
        if (root is Button button && IsMoleWindowsButton(button))
        {
            Freeze(button);
        }
    ...
    private static bool IsMoleWindowsButton(Button button)
    {
        return IsMoleWindowsStyle(button.Style);
    }

    private static bool IsMoleWindowsStyle(Style? style)
    {
        while (style is not null)
        {
            foreach (var key in MoleWindowsButtonStyleKeys)
            {
