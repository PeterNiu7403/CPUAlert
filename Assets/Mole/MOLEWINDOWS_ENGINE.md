# MoleWindows Mole Engine Asset

This folder vendors the `tw93/Mole` Windows branch runtime scripts so MoleWindows can resolve a local OS engine before falling back to a user PATH installation.
